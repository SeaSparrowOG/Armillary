...
namespace BoundEffectManager
{
	...
	void BoundEffectManager::Revert(SKSE::SerializationInterface* a_intfc) {
		(void)a_intfc;
		player->RestoreActorValue(RE::ACTOR_VALUE_MODIFIER::kPermanent, RE::ActorValue::kHealth, totalHealthBound);
		player->RestoreActorValue(RE::ACTOR_VALUE_MODIFIER::kPermanent, RE::ActorValue::kStamina, totalStaminaBound);
		player->RestoreActorValue(RE::ACTOR_VALUE_MODIFIER::kPermanent, RE::ActorValue::kMagicka, totalMagickaBound);
